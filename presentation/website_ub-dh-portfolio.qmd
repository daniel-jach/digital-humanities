...
{{< iconify streamline-plump:industry-innovation-and-infrastructure-solid  style="color: #83B818; margin-bottom: 25px;" width=150px >}} 
...
Weitere Informationen zum Thema FDM finden Sie hier [{{< iconify streamline-sharp:link-share-2 >}}](https://fdm.tu-dortmund.de/).
...
<!-- # Technologie & Library Labs -->

## row {.fill}

::: {.card title="Technik" fill='true' height='500px'}

{{< iconify pixel:technology style="color: #83B818; margin-bottom: 25px;" width=150px >}} 
...
{{< iconify streamline:ai-gaming-spark style="color: #83B818; margin-bottom: 25px;" width=150px >}} 
...
::: {.card title="Publikation & Sichtbarkeit" fill='true' height='500px'}
...
::: {.card title="Archivierung & Bewahrung" fill='true' height='500px'}
